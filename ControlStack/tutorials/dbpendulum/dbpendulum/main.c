...
char xmlpath[] = "/home/pang/repo/robotics/ARCHER_hopper/ControlStack/tutorials/dbpendulum/dbpendulum/doublependulum.xml";
char datapath[] = "/home/pang/repo/robotics/ARCHER_hopper/ControlStack/tutorials/dbpendulum/dbpendulum/data.csv";
...
//   //M*(-kp( ... ) - kv(...) + f)
   ...
   printf("current %f %f  while ref %f %f \n",d->qpos[0], d->qpos[1], qref1 , qref2);
