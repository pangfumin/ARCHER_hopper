...
char filename[] = "/home/pang/repo/robotics/ARCHER_hopper/ControlStack/tutorials/control_pendulum/control_pendulum/pendulum.xml";
...
void mycontroller(const mjModel* m, mjData* d)
{
  ...
  d->ctrl[0] = -10*(d->qpos[0]-0)-10*d->qvel[0];//PD control
//   //d->ctrl[0] = -10*(d->sensordata[0]-0)-1*d->sensordata[1];
//   printf("%f %f\n", d->sensordata[0], d->sensordata[1]);
